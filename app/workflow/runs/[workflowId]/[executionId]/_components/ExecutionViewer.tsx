...
export function ExecutionViewer({
  ...
  return (
    <div className="flex w-full h-full">
      <aside className="w-[440px] min-w-[440px] max-w-[440px] border-r-2 border-separate flex flex-gow flex-col overflow-hidden">
      ...
      <div className="flex w-full h-full">
        {isRunning && (
          <div className="flex items-center flex-col gap-2 justify-center h-full w-full">
            <p className="font-bold">Workflow is running, Please wait</p>
          </div>
        )}
